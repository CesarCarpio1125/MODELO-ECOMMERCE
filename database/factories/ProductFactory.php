...
use App\Models\User;
use App\Modules\Vendor\Vendor; // <-- CORREGIDO
use Illuminate\Database\Eloquent\Factories\Factory;

/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Modules\Vendor\Product>
 */
class ProductFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'vendor_id' => Vendor::factory(), // <-- AGREGADO: Relación con vendor
